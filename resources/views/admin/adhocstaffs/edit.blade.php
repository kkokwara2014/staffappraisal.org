        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="box">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{ route('adhocstaffs.update',$adhocstaff->id) }}" method="post">
                            {{ csrf_field() }}
                            @method('put')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="lastname" type="text"
                                                    ...
                                                    name="lastname" value="{{ $adhocstaff->lastname }}"  autofocus
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="middlename" type="text" class="form-control"
                                                    name="middlename" value="{{ $adhocstaff->middlename }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" type="text"
                                                    ...
                                                    name="firstname" value="{{ $adhocstaff->firstname }}"  autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="staffnumb" type="text"
                                                    ...
                                                    name="staffnumb" value="{{ $adhocstaff->staffnumb }}"  placeholder="Staff number e.g. SS-00755"
                                                    maxlength="8">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="email" type="email"
                                                    ...
                                                    name="email" value="{{ $adhocstaff->email }}"  autofocus
                                                    placeholder="Email">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="phone" type="tel"
                                                    ...
                                                    name="phone" value="{{ $adhocstaff->phone }}"  placeholder="Phone"
                            ...
                            <a href="{{ route('adhocstaffs.index') }}" class="btn btn-danger btn-sm">Cancel</a>
                            <button type="submit" class="btn btn-primary btn-sm"><span class="fa fa-floppy-o"></span> Update</button>
                        </form>
                    </div>
                    <!-- /.box-body -->
                </div>
