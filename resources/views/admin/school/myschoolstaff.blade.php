...
<div class="row">
    ...
    <section class="col-lg-12 connectedSortable">
        ...
        <div class="row">
            <div class="col-md-12">
                <p>
                    <span class="badge badge-pill" style="background-color: green; color: honeydew; font-size: 21px">Num. of Staff : {{ $myschooldepartmentstaffscount }}</span>
                </p>
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-responsive table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @foreach ($myschooldepartmentstaffs as $staff)
                                <tr>
                                    <td>
