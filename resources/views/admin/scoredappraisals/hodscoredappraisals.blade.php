                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-responsive table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($hodscoredappraisals as $subapp)
                                @if ($subapp->user_id==auth()->user()->id || auth()->user()->hasAnyRole(['Dean']) || auth()->user()->hasAnyRole(['Director']) || auth()->user()->hasAnyRole(['Admin']) ||auth()->user()->hasAnyRole(['Rector']) || auth()->user()->hasAnyRole(['Registrar']) || $subapp->sentto_id==auth()->user()->id)
                                <tr>
