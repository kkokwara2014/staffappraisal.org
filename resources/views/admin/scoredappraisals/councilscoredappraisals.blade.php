                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-responsive table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($councilscoredappraisals as $subapp)
                                @if ($subapp->user_id==auth()->user()->id || auth()->user()->hasAnyRole(['Council']) || auth()->user()->hasAnyRole(['Management']) || auth()->user()->hasAnyRole(['Rector']) || auth()->user()->hasAnyRole(['Admin']) || auth()->user()->hasAnyRole(['Registrar']) || $subapp->sentto_id==auth()->user()->id)
                                <tr>
