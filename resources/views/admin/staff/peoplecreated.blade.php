...
@section('title')
Staff created by {{ $staff->firstname.' '.$staff->lastname.' ['.$staff->staffnumb.']' }}
@endsection
...
<div class="row">
    ...
    <section class="col-lg-12 connectedSortable">
        <p>
            ...
            &nbsp;
            &nbsp;
            <span class="badge badge-pill badge-success" style="background-color: green; color: honeydew">Total: {{ $totalstaffcount }}</span>
        </p>
