    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <img src="{{url('user_images',$staff->userimage)}}" width="120" height="120"
                    style="border-radius: 50%; float: right">
                <h4>
                    Staff Name:
                    {{$staff->title->title.' '.ucfirst($staff->firstname).' '.($staff->middlename!=''?ucfirst($staff->middlename):'').' '.ucfirst($staff->lastname)}}
                    <br>
        ...
        @else
        <span style="background-color: red; color: honeydew" class="badge badge-pill badge-danger">No submission
            made</span>
        @endif
            ...
            <tbody>
                ...
                <div>
                    ...
                    <tr>
                        ...
                        download="{{ $publi->pubfilename }}"><span style="color: red" class="fa fa-file-pdf-o"></span>
            ...
            <tbody>
                ...
                <div>
                    ...
                    <tr>
                        ...
                        download="{{ $prod->prodfilename }}"><span style="color: red" class="fa fa-file-pdf-o"></span>
                        <span class="fa fa-download"></span> </a>
                        </td> --}}
                    </tr>
